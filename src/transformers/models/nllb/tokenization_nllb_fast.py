...
PRETRAINED_VOCAB_FILES_MAP = {
    "vocab_file": {
        "facebook/nllb-large-en-ro": (
            "https://huggingface.co/facebook/nllb-large-en-ro/resolve/main/sentencepiece.bpe.model"
        ),
    ...
    "tokenizer_file": {
        "facebook/nllb-large-en-ro": "https://huggingface.co/facebook/nllb-large-en-ro/resolve/main/tokenizer.json",
        "facebook/nllb-200-distilled-600m": "https://huggingface.co/facebook/nllb-200-distilled-600m/resolve/main/tokenizer.json",
    },
}
...
class NllbTokenizerFast(PreTrainedTokenizerFast):
    ...
    ...     "facebook/nllb-large-en-ro", src_lang="en_XX", tgt_lang="ro_RO"
    ... )
