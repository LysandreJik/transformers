...
from .configuration_{{cookiecutter.lowercase_modelname}} import {{cookiecutter.modelname}}Config
...
_CONFIG_FOR_DOC = "{{cookiecutter.modelname}}Config"
_TOKENIZER_FOR_DOC = "{{cookiecutter.modelname}}Tokenizer"
...
{{cookiecutter.modelname}}LayerNorm = torch.nn.LayerNorm


class {{cookiecutter.modelname}}Embeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.LayerNorm = {{cookiecutter.modelname}}LayerNorm(config.hidden_size, eps=config.layer_norm_eps)
...
class {{cookiecutter.modelname}}SelfAttention(nn.Module):
    def __init__(self, config):
        super().__init__()
    ...
    def forward(
        ...
        if attention_mask is not None:
            # Apply the attention mask is (precomputed for all layers in {{cookiecutter.modelname}}Model forward() function)
...
class {{cookiecutter.modelname}}SelfOutput(nn.Module):
    def __init__(self, config):
        super().__init__()
...
class {{cookiecutter.modelname}}Attention(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.self = {{cookiecutter.modelname}}SelfAttention(config)
        self.output = {{cookiecutter.modelname}}SelfOutput(config)
...
class {{cookiecutter.modelname}}Intermediate(nn.Module):
    def __init__(self, config):
        super().__init__()
...
class {{cookiecutter.modelname}}Output(nn.Module):
    def __init__(self, config):
        super().__init__()
...
class {{cookiecutter.modelname}}Layer(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.chunk_size_feed_forward = config.chunk_size_feed_forward
        self.seq_len_dim = 1
        self.attention = {{cookiecutter.modelname}}Attention(config)
        self.is_decoder = config.is_decoder
        self.add_cross_attention = config.add_cross_attention
        if self.add_cross_attention:
            assert self.is_decoder, f"{self} should be used as a decoder model if cross attention is added"
            self.crossattention = {{cookiecutter.modelname}}Attention(config)
        self.intermediate = {{cookiecutter.modelname}}Intermediate(config)
        self.output = {{cookiecutter.modelname}}Output(config)
...
class {{cookiecutter.modelname}}Encoder(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.config = config
        self.layer = nn.ModuleList([{{cookiecutter.modelname}}Layer(config) for _ in range(config.num_hidden_layers)])
...
class {{cookiecutter.modelname}}Pooler(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.dense = nn.Linear(config.hidden_size, config.hidden_size)
...
class {{cookiecutter.modelname}}PredictionHeadTransform(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.dense = nn.Linear(config.hidden_size, config.hidden_size)
        if isinstance(config.hidden_act, str):
...
class {{cookiecutter.modelname}}LMPredictionHead(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.transform = {{cookiecutter.modelname}}PredictionHeadTransform(config)
...
class {{cookiecutter.modelname}}OnlyMLMHead(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.predictions = {{cookiecutter.modelname}}LMPredictionHead(config)
...
class {{cookiecutter.modelname}}OnlyNSPHead(nn.Module):
    def __init__(self, config):
        super().__init__()
...
class {{cookiecutter.modelname}}PreTrainingHeads(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.predictions = {{cookiecutter.modelname}}LMPredictionHead(config)
        self.seq_relationship = nn.Linear(config.hidden_size, 2)
...
@dataclass
class {{cookiecutter.modelname}}ForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~transformers.{{cookiecutter.modelname}}ForPreTrainingModel`.
...
@add_start_docstrings(
    """{{cookiecutter.modelname}} Model with two heads on top as done during the pre-training: a `masked language modeling` head and
    a `next sentence prediction (classification)` head. """,
    {{cookiecutter.modelname}}_START_DOCSTRING,
)
class {{cookiecutter.modelname}}ForPreTraining({{cookiecutter.modelname}}PreTrainedModel):
    def __init__(self, config):
        super().__init__(config)

        self.{{cookiecutter.lowercase_modelname}} = {{cookiecutter.modelname}}Model(config)
        self.cls = {{cookiecutter.modelname}}PreTrainingHeads(config)
    ...
    @add_start_docstrings_to_callable({{cookiecutter.modelname}}_INPUTS_DOCSTRING.format("(batch_size, sequence_length)"))
    @replace_return_docstrings(output_type={{cookiecutter.modelname}}ForPreTrainingOutput, config_class=_CONFIG_FOR_DOC)
    def forward(
        self,
        input_ids=None,
        attention_mask=None,
        ...
        **kwargs
        ...
        Examples::
            ...
            >>> from transformers import {{cookiecutter.modelname}}Tokenizer, {{cookiecutter.modelname}}ForPreTraining
            >>> import torch

            >>> tokenizer = {{cookiecutter.modelname}}Tokenizer.from_pretrained('{{cookiecutter.lowercase_modelname}}-base-uncased')
            >>> model = {{cookiecutter.modelname}}ForPreTraining.from_pretrained('{{cookiecutter.lowercase_modelname}}-base-uncased', return_dict=True)
        ...
        return {{cookiecutter.modelname}}ForPreTrainingOutput(
            loss=total_loss,
...
class {{cookiecutter.modelname}}LMHeadModel({{cookiecutter.modelname}}PreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
...
@add_start_docstrings(
    """{{cookiecutter.modelname}} Model with a `next sentence prediction (classification)` head on top. """,
    {{cookiecutter.modelname}}_START_DOCSTRING,
)
class {{cookiecutter.modelname}}ForNextSentencePrediction({{cookiecutter.modelname}}PreTrainedModel):
    def __init__(self, config):
        super().__init__(config)

        self.{{cookiecutter.lowercase_modelname}} = {{cookiecutter.modelname}}Model(config)
        self.cls = {{cookiecutter.modelname}}OnlyNSPHead(config)
    ...
    def forward(
        ...
        Example::
            ...
            >>> from transformers import {{cookiecutter.modelname}}Tokenizer, {{cookiecutter.modelname}}ForNextSentencePrediction
            >>> import torch

            >>> tokenizer = {{cookiecutter.modelname}}Tokenizer.from_pretrained('{{cookiecutter.lowercase_modelname}}-base-uncased')
            >>> model = {{cookiecutter.modelname}}ForNextSentencePrediction.from_pretrained('{{cookiecutter.lowercase_modelname}}-base-uncased', return_dict=True)
...
class {{cookiecutter.modelname}}ForTokenClassification({{cookiecutter.modelname}}PreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
