@add_start_docstrings(
    """{{cookiecutter.model_name}} Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
    layers on top of the hidden-states output to compute `span start logits` and `span end logits`). """,
    {{cookiecutter.model_name}}_START_DOCSTRING,
)
class {{cookiecutter.model_name}}ForQuestionAnswering({{cookiecutter.model_name}}PreTrainedModel):
